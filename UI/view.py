...
class View(ft.UserControl):
    ...
    def load_interface(self):
        ...
        self.ddCodins = ft.Dropdown(label="Corso", on_change=self._controller.ddCodinsSelected) #le voci del DD me le da il database --> creo un metodo nel controller per fare il fill
